// https://github.com/dragino/dragino-end-node-decoder/blob/main/LSN50v2-D20-D22-D23/LSN50v2-D20-Decoder.txt

class LSN50v2 {
    
    // Takes base64 encoded payload string
    static decode(payload) {
        let bytes = Uint8Array.from(Buffer.from(payload, 'base64'));
    
        let mode = (bytes[6] & 0x7C)>>2;
        let decode = {};
