...
function data4Info(bytes,num)
{
  ...
  let value1 = (bytes[9+num] << 8) | bytes[8+num];
  let uValue1 = value1 & 0xFFFF;
  if (uValue1 & 0x8000) 
  {
    uValue1 = -(uValue1 & 0x7FFF);
  }
  temp1 = parseFloat((uValue1 / 10).toFixed(1));
  
  let value2 = (bytes[11+num] << 8) | bytes[10+num];
  let uValue2 = value2 & 0xFFFF;
  if (uValue2 & 0x8000) {
  uValue2 = -(uValue2 & 0x7FFF);
  }
  temp2 = parseFloat((uValue2 / 10).toFixed(1));
